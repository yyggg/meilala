<?php
	...
	if(isset($_GET['ajax-goods']))
	{
		...
		$sql = "SELECT gid,name,market_price,price,gimg FROM m_goods $where ORDER BY gid DESC LIMIT $start, $pageSize";
...
<div class="content">
    ...
    <div class="item-loading" id="loading">正在努力加载...</div>
    <div class="item-loading" id="nomoreresults">没有更多的数据了...</div>
</div>
	...
	$('.item_ct').scrollPagination({
		...
		'loader': function (data){
			$.each(data, function(k, v){
				...
				var html = '<a href="goods_detail.php?gid='+v.gid+'">'+
					'<div class="item_li">'+
						'<div class="item_li_border"></div>'+
						'<div class="li_img" style="background-image:url(<?php echo IMG_PATH;?>'+v.gimg+'); "></div>'+
