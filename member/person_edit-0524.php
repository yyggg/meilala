...
<header class="header">
    ...
    <h2>资料修改</h2>
    <div class="header_right"><a href="#" onclick="personSave();"></a></div>
</header>
<!--header end-->
<!--content-->
<div class="content">
	<ul>
    	<li class="my_li my_varify"><span class="my_keywords"><b>*</b>头像</span><span class="my_value"><img src="<?php echo $data['headimgurl'];?>" /></span><input type="file" id="my_varify" unat="server" accept="image/*" capture="camera"/><canvas id="canvas"></canvas></li>
        <li class="my_li"><span class="my_keywords"><b>*</b>昵称</span><input class="my_value" id="name" value="<?php echo $data['name'];?>"/></li>
        <li class="my_li"><span class="my_keywords"><b>*</b>电话</span><input type="tel" class="my_value" id="phone" value="<?php echo $data['phone'];?>"/></li>
        <li class="my_li"><span class="my_keywords"><b>*</b>邮箱</span><input type="email" class="my_value" id="email" value="<?php echo $data['email'];?>"/></li>
        <li class="my_li"><span class="my_keywords"><b>*</b> Q Q </span><input type="number" class="my_value" id="qq" value="<?php if($data['qq']) echo $data['qq'];?>"/></li>
        <li class="my_li">
	        <span class="my_keywords"><b>*</b>性别</span>
	        <span class="my_value">
		        <input type="radio" name="sex" value="1" <?php if($data['sex'] == '1') echo 'checked' ;?> />男
				<input type="radio" name="sex" value="0" <?php if($data['sex'] == '0') echo 'checked' ;?> />女
			</span>
		</li>
        <li class="my_li"><span class="my_keywords"><b>*</b>生日</span><input class="my_value" id="birthday" type="date" value="<?php echo date('m月d日',$data['birthday']);?>"/></li>
