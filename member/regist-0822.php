<?php
	...
	if(isset($_GET['send_sms']))
	{
		...
		if(preg_match('/^1[34578][0-9]{9}$/',$mobile))
		{
			...
			$url .= "&mobile=$mobile&content=【美啦啦】您的验证码是：" . $code;
...
.yzm {position: relative;}
  .yzm .yzm_input{   background-color: #EFEFEF; border: 0rem; width: 90%; margin:  0.5rem 5%; border-radius: 0.3rem; height: 2.5rem; line-height: 2.5rem; box-sizing:border-box; padding: 0 0.5rem;}
  .yzm .yzm_button { position: absolute; width: 5rem; right: 5%; top: 0.5rem; height: 2.5rem; background: #673f88; color: #fff; border: 0rem;}
  .yzm  .yzm_button img    { height: 2.5rem; width: 5rem;}
</style>
<body>
<!--header-->
<header class="header">
...
<div class="zc_bg">
    ...
    <div class="zc_block yzm">
      <input type="tel" placeholder="请输入右边验证码" value="" class="yzm_input">
      <div class="yzm_button "><img src="../images/aa_yzm.png" alt="" /></div>
    </div>       
    <div class="zc_block yzm">
