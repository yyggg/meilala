...
<div class="content">
	<ul>
    	<li class="my_li my_varify"><span class="my_keywords"><b>*</b>头像</span><span class="my_value"><img src="<?php echo $data['headimgurl'];?>" /></span></li>
        <li class="my_li"><span class="my_keywords"><b>*</b>昵称</span><span class="my_value"><?php echo $data['name'];?></span></li>
        <li class="my_li"><span class="my_keywords"><b>*</b>电话</span><span class="my_value"><?php echo $data['phone'];?></span></li>
        ...
        <li class="my_li"><span class="my_keywords"><b>*</b>性别</span><span class="my_value"><?php if($data['sex']==0) echo '女'; elseif($data['sex']==1) echo '男'; else echo '保密';?></span></li>
