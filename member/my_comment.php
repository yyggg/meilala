...
<div class="content mb10">
    ...
    <div class="act_dtl_ct mt10 act_comment my_comment">
		<ul>
		...
		'loader': function (data){
			if(data.length)
			{
				...
				$.each(data, function(k, v){
					...
					html += '<li class="detail_comment mt10 mb10 pt10 clearfix my_comment_li">'+
						'<div class="my_comment_ct1"><i class="my_comment_time">'+v.ctime+'</i> 评论了 <span onclick="window.location.href=/member/goods/goods?gid='+v.pid+'">'+v.name+'</span></div>'+
						'<div class="cm my_comment_ct2">'+
