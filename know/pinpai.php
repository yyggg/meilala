...
<body onmousewheel="return false;">
	<div class="container">
		<div class="page page0 cur">
        	<div class="know_img" style="background-image:url(../images/02.jpg);" ></div>
		</div>
		<div class="page page1">
			<div class="know_img" style="background-image:url(../images/04.jpg);" ></div>
		</div>
		<div class="page page2">
        	<div class="know_img" style="background-image:url(../images/06.jpg);" ></div>
        </div>
	</div>
