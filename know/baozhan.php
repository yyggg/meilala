...
<body onmousewheel="return false;">
	<div class="container">
		<div class="page page0 cur">
        	<div class="know_img" style="background-image:url(../images/01.jpg);" ></div>
		</div>
		<div class="page page1">
			<div class="know_img" style="background-image:url(../images/08.jpg);" ></div>
		</div>
		<div class="page page2">
        	<div class="know_img" style="background-image:url(../images/09.jpg);" ></div>
        </div>
	</div>
