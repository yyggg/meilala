...
wx.ready(function () {
    ...
    {
        var share_id=<? echo $partner_message_id?>;
        var partner_id=<? echo $hhr_partner_id ?>;
       
            $.post('http://m.meilala.net/plus/hhr_share_record.php',{share_id:share_id,partner_id:partner_id,type:type}, function(res){
                if(res.flag==1)
                {
                    return 1;
                }
