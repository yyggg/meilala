...
if (strpos($_SERVER['HTTP_USER_AGENT'], "MicroMessenger")){	
	$base64_query  =   str_replace('&from=groupmessage&isappinstalled=0','',str_replace('&from=singlemessage&isappinstalled=0','',str_replace('&from=timeline&isappinstalled=0','',$_SERVER["QUERY_STRING"])));
	$url_query=base64_decode(substr($base64_query,2));
	$_GET['s']=get_query('s',$url_query);
