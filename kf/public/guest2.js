...
*/
	switch (type) {
        case 1:
            d = '<div class="time">' + getLocalTime() + '</div><div class="msg l"><img src="'+headimgurl+'" class="var_img fl"/><b></b><div class="b a_msg"><div class="i ">' + format_output(d) + '</div></div></div><div style="clear:both" ></div>';
            break;
        case 2:
            d = '<div class="time">' + getLocalTime() + '</div><div class="msg r"><img src="images/var_img.png" class="var_img fr"/><b></b><div class="b"><div class="i ">' + format_output(d) + '</div></div></div><div style="clear:both" ></div>';
            break;
        case 3:
            d = '<div class="msg s"><div class="b"><div class="ico"></div><div class="i">' + d + '</div></div></div>';
            break;
...
/*	
	historier.css("padding-bottom", 0).html('').append('<div class="comment"><form id="comment_form" onsubmit="return false;"><input type="hidden" name="vid" value="' + vid + '"><input type="hidden" name="key" value="' + SYSKEY + '"><input type="hidden" name="code" value="' + SYSCODE + '"><li><b>' + langs.yourname + ':</b><input name="fullname" type="text"><i>*</i></li><li><b>' + langs.email + ':</b><input name="email" type="text"><i>*</i></li><li><b>' + langs.phone + ':</b><input name="phone" type="text"></li><li><b>' + langs.content + ':</b><textarea name="content"></textarea><i>*</i></li></form></div>')
