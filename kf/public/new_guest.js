...
function welive_link() {
    ...
    var request=$.post('wx_user.php?x=9',{openid: guest.openid,gid:guest.gid}); 
	request.abort();       
			...
			$.each(data.re, function(i, rec) {
				...
				*/
				if (rec.t == 1) {
					...
					recs += '<div class="time">' + rec.d + '</div><div class="msg r"><img src="'+headimgurl+'" class="var_img fr"/><b></b><div class="b"><div class="i ">' + format_output(rec.m) + '</div></div></div><div style="clear:both" ></div>'
				}				
			});
			if (recs != '') {
...
*/
	switch (type) {
        case 1:
            ...
            break;
        case 2:
            d = '<div class="time">' + getLocalTime() + '</div><div class="msg r"><img src="'+headimgurl+'" class="var_img fr"/><b></b><div class="b"><div class="i ">' + format_output(d) + '</div></div></div><div style="clear:both" ></div>';
            break;
        case 3:
            d = '<div class="msg s"><div class="b"><div class="ico"></div><div class="i">' + d + '</div></div></div>';
            break;
