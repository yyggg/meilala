...
Dialog.prototype.create = function () {
    ...
    if (DialogDivWidth > bd.clientWidth) this.Width = Math.round((bd.clientWidth - 26)*0.7);
    if (DialogDivHeight > bd.clientHeight) this.Height = Math.round(bd.clientHeight - 46 - (this.ShowButtonRow ? 40 : 0) - (this.ShowMessageRow ? 50 : 0));
    var html = '\
  <table id="_DialogTable_' + this.ID + '" class="Dialogtable" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" class="Draghandle" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      <td width="13" height="33" class="Draghandle1" style="background-image: url(' + IMAGESPATH + 'dialog_lt.png) ; background: url(' + IMAGESPATH + 'dialog_lt.gif) no-repeat 0 0;"><div style="width: 13px;"></div></td>\
      <td height="33" class="Draghandle2" style="background-image:url(' + IMAGESPATH + 'dialog_ct.png) ; background: url(' + IMAGESPATH + 'dialog_ct.gif) repeat-x top;"><div style="padding: 9px 0 0 4px; float: left; font-weight: bold; color:#fff;"><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
      ...
      <td width="13" height="33" class="Draghandle3" style="background-image: url(' + IMAGESPATH + 'dialog_rt.png);  background: url(' + IMAGESPATH + 'dialog_rt.gif) no-repeat right 0;"><div style="width: 13px;"><a id="_forTab_' + this.ID + '" href="#;"></a></div></td>\
    </tr>\
    <tr valign="top" class="DragContent">\
      <td width="13" class="DragContent1" style="background-image: url(' + IMAGESPATH + 'dialog_mlm.png) ; background: url(' + IMAGESPATH + 'dialog_mlm.gif) repeat-y left;"></td>\
      <td class="DragContent2" align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">\
	...
	' + (function (obj) {
        ...
        if (obj.URL) return '<iframe width="100%" name="iframe" height="100%" frameborder="0" style="border:none 0;" allowtransparency="true" id="_DialogFrame_' + obj.ID + '" src="' + obj.displacePath() + '"></iframe>';
        return "";
    })(this) + '\
              </div></td>\
          </tr>\
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '" class="ButtonRow">\
            <td height="36"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 8px 20px; text-align: right; background-color:#f6f6f6;">\
                <input type="button" class="buttonStyle buttonStyle1" value="确 定" id="_ButtonOK_' + this.ID + '"/>\
                <input type="button" class="buttonStyle buttonStyle2" value="取 消" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '"/>\
              </div></td>\
          </tr>\
        </table></td>\
      <td width="13" class="DragContent3" style="background-image: url(' + IMAGESPATH + 'dialog_mrm.png);  background: url(' + IMAGESPATH + 'dialog_mrm.gif) repeat-y right;"></td>\
    </tr>\
    <tr class="DragFooter">\
      <td width="13" class="DragFooter1" height="13" style="background-image: url(' + IMAGESPATH + 'dialog_lb.png) ; background: url(' + IMAGESPATH + 'dialog_lb.gif) no-repeat 0 bottom;"></td>\
      <td class="DragFooter2" style="background-image: url(' + IMAGESPATH + 'dialog_cb.png) ; background: url(' + IMAGESPATH + 'dialog_cb.gif) repeat-x bottom;"></td>\
      <td class="DragFooter3" width="13" height="13" style="background-image: url(' + IMAGESPATH + 'dialog_rb.png) ; background: url(' + IMAGESPATH + 'dialog_rb.gif) no-repeat right bottom;"><a onfocus=\'$id("_forTab_' + this.ID + '").focus();\' href="#;"></a></td>\
    </tr>\
  </table>\
</div>\
'
...
Dialog.alert = function (msg,title, func, w, h) {
    var w = w || 300,
        h = h || 110;
    var diag = new Dialog({
        Width: w,
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr>\
			<td align="left" id="Message_' + this.ID + '" style="font-size:1rem">' + msg + '</td></tr>\
	</table>';
    diag.show();
